...
var CELULAR_EMPRESA = '555193627720';
var LINK_INSTAGRAM = 'https://www.instagram.com/lee_ezequiel33/';
var LINK_TELEGRAM = 'https://t.me/Leemagic30';
...
cardapio.metodos = {
  ...
  carregarResumo: () => {
    ...
    $('#resumoEndereco').html(`${MEU_ENDERECO.endereco}, ${MEU_ENDERECO.numero}, 
    ${MEU_ENDERECO.bairro}`);
  ...
  // Carrega o botão do WhatsApp footer
